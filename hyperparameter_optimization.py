...
def hyperparameter_optimization(adenosine_star = False,
                                NUM_NODE_FEATURES = 9,
                                NUM_EDGE_FEATURES = 3,
                                max_epochs = 200,
                                n_samples = 100,
                                ...
                                hidden_dimensions = tune.choice([16, 32, 64, 128, 256, 512, 1024]),
    ...
    gnn_config = {
        ...
        'hidden': hidden_dimensions,  # embedding/hidden dimensions
    ...
    return test_results, end-start # return the results and the time the optimization took
