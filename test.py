...
from network import GNN_GINE, GNN_GAT
...
def main():
    ...
    results = pool.starmap(temp_func, [(5,0,config,data_module,test_loader) for n_node in parameters['N'] for n_edge in parameters['E']])
    print(results)
    pool.close()
    pool.join()
